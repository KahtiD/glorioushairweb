...
render() {
  ...
  <div>
      <div style={{width: '354.9px', margin: '0 auto', height: '39.36px'}}>
        ...
        :
          <div className={ this.state.show1 ? "selectedBox" : defaultLace === 'Closure' ? "nonselectedBox" : "selectorBox"} onClick={this.handleSelect1.bind(this)}>
            <h1 className="selectorText">Frontal</h1>
          </div>
        }
        ...
        :
        <div className={ this.state.show2 ? "selectedBox" : defaultLace === 'Frontal' ? "nonselectedBox" : "selectorBox"} onClick={this.handleSelect2.bind(this)}>
          <h1 className="selectorText">Closure</h1>
        </div>
      }
      </div>
